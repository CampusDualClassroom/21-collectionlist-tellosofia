...
class ExerciseTest {
    ...
    void testCreateArrayList() {
        List<String> arrayList = Exercise.createArrayList();
    ...
    void testAddUniqueElement() {
        List<String> arrayList = Exercise.createArrayList();
        boolean addedElement = Exercise.addElementToList(arrayList, "AAAAA");
    ...
    void testAddDuplicateElment() {
        List<String> arrayList = Exercise.createArrayList();
        boolean addedElement1 = Exercise.addElementToList(arrayList, "AAAAA");
        boolean addedElement2 = Exercise.addElementToList(arrayList, "AAAAA");
